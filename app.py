...
from rag_engine import RagEngine, load_dataset, load_store, save_store
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Minimal RAG pipeline (Excel -> OpenAI embeddings -> FAISS -> grounded answers)")
    ...
    a.add_argument(
        "--no-llm",
        action="store_true",
        help="Do not call chat model; only print retrieved results (same as --raw)",
    )
